...
<acme:form>
	...
	<acme:input-textbox code="any.user-account.form.label.role" path="roles" readonly="true"/>
	...
	<jstl:if test="${canUpdate}">
		...
		<acme:submit code="any.user-account.form.button.update" action="/administrator/user-account/update"/>
	</jstl:if>
</acme:form>
