...
<acme:form>
	...
	<acme:button code="any.toolkit.form.button.tools" action="/any/item/list?type=TOOL&masterId=${id}"/>
	<acme:button code="any.toolkit.form.button.components" action="/any/item/list?type=COMPONENT&masterId=${id}"/>
</acme:form>